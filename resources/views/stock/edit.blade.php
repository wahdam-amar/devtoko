            ...
            <div class="flex flex-wrap overflow-hidden md:-mx-6">
                ...
                <div class="md:flex-1 w-full overflow-hidden md:my-6 md:px-6 md:w-1/3">
                    ...
                    <div class=" my-2 p-1 bg-white flex border border-gray-200 rounded">
                        <input name="name" type="text" placeholder="Nama" value="{{ Str::title($stock->name) }}"
                ...
                <div class="md:flex-1 w-full overflow-hidden md:my-6 md:px-6 md:w-1/3">
                    ...
                    <div class=" my-2 p-1 bg-white flex border border-gray-200 rounded">
                        <input placeholder="Keterangan" name="desc" type="text" value="{{ Str::title($stock->desc) }}"
                            class="p-1 px-2 appearance-none outline-none w-full text-gray-800 ">
                    </div>
                </div>
            ...
            <div class="flex flex-wrap overflow-hidden md:-mx-6">
                ...
                <div class="w-full overflow-hidden md:my-6 md:px-6 md:w-1/3">
                    <label class="block uppercase tracking-wide text-charcoal-darker text-xs font-bold">Harga
                        Jual</label>
                    <div class=" my-2 p-1 bg-white flex border border-gray-200 rounded">
                        <input name="price_sell" type="number" placeholder="Harga Jual" value="{{ $stock->price_sell }}"
                            class="p-1 px-2 appearance-none outline-none w-full text-gray-800 ">
                    </div>
                </div>
                ...
                <div class="w-full overflow-hidden md:my-6 md:px-6 md:w-1/3">
                    <label class="block uppercase tracking-wide text-charcoal-darker text-xs font-bold">Harga
                        Beli</label>
                    <div class=" my-2 p-1 bg-white flex border border-gray-200 rounded">
                        <input name="price_buy" type="number" placeholder="Harga Beli" value="{{ $stock->price_buy }}"
                            class="p-1 px-2 appearance-none outline-none w-full text-gray-800 ">
                    </div>
                </div>
