...
<div class="antialiased sans-serif min-h-screen bg-white" style="min-height: 900px">
                    ...
                    <div class="mb-2 md:mb-1 md:flex items-center">
                        ...
                        <div class="flex-1">
                            <input name="name"
                                ...
                                id="inline-full-name" type="text" value="eg. #INV-100001" x-model="invoiceNumber"
                                readonly>
                        </div>
                    </div>
                    ...
                    <div class="mb-2 md:mb-1 md:flex items-center">
                        ...
                        <div class="flex-1">
                            <input
                                ...
                                type="text" name="date" id="datepicker1" placeholder="eg. 17 Feb, 2020"
                                x-model="invoiceDate"
    ...
    Date.prototype.addDays = function(days) {
        ...
        picker2.setDate(new Date().addDays(7));
    });
    ...
    function invoices() {
        return {
            ...
            generateInvoiceNumber(minimum, maximum) {
                ...
                this.invoiceNumber = 'INV-00000';//'#INV-'+ randomNumber;
            },
