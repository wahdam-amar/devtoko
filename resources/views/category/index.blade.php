...
<div class="bg-white p-6 rounded shadow">
    <h2 class="mb-2 text-2xl font-medium">Category</h2>
    ...
    <div
        ...
        <div class="modal-content py-4 text-left px-6">
            ...
            <div class="flex justify-end pt-2">
                ...
                {{-- form delete --}}
                <form class="form-delete" action="{{ route('category.destroy',1)}}" method="post">
                    @csrf
                    @method('DELETE')
...
<script>
    ...
    const openModal = (name,id) => {
        ...
        formDelete[0].action=`http://localhost:8000/category/${id}`;
